...
var _require = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"),
    axios = _require["default"]; // encargado de llevar la logica
  ...
  short_url: function short_url() {
    ...
    if (shorter.validate_url(long_url)) {
      ...
      axios.post('/url', {
        ...
        document.getElementById('short_url_container').style.display = 'block'; // vamos a colocar el valor de la url recortada
